    ...
    if args.finetune:
        t.append(
            transforms.Resize((args.input_size, args.input_size),
                              interpolation=InterpolationMode.BICUBIC)  # 修改为使用InterpolationMode枚举
            )
    else:
        if resize_im:
            ...
            t.append(
                ...
                transforms.Resize(size, interpolation=InterpolationMode.BICUBIC),  # 修改为使用InterpolationMode枚举
            )
